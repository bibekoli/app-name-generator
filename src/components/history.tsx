      ...
      <ul className="flex flex-col h-full overflow-y-scroll">
        {
          history["history"]?.length > 0 && (
            <button className="flex items-center gap-2 justify-center p-2 m-2 text-lg font-bold rounded-lg px-2 bg-red-500 text-white" onClick={() => setHistory("history", [], { path: "/" })}>
